...
class MyDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, transform=None,valid=False):
        ...
        if valid:
            ...
            # self.root='D:/bdd/TwinLiteNet-main/data/bdd100k/images/val'
            self.root='/media/adeel/940A23050A22E3C8/dataset/bdd100k/images/val'
            # self.root='/media/usman/Lab/datasets/dk100/images/val'  
            self.names=os.listdir(self.root)
        else:
          
            # self.root='D:/bdd/TwinLiteNet-main/data/bdd100k/images/train'
            # self.root='D:/dataset/bdd100k/images/train'
            self.root='/media/adeel/940A23050A22E3C8/dataset/bdd100k/images/train/' 
